...
def original():
    ...
    path_train = os.path.dirname(os.getcwd()) + '\\data\\'
    path_test = os.path.dirname(os.getcwd()) + '\\data\\'

    trainset = torchvision.datasets.OxfordIIITPet(root=path_train,
                                                  split="trainval",
                                                  target_types="segmentation",
                                                  download=False)


    testset = torchvision.datasets.OxfordIIITPet(root=path_test,
                                                 split="test",
                                                 target_types="segmentation",
                                                 download=True)
...
def augmented():
    ...
    trainset = OxfordIIITPetsAugmented(root=path_train,
                                       split="trainval",
                                       target_types="segmentation",
                                       download=False,
                                        **utils.core.transform_dict)


    testset = OxfordIIITPetsAugmented(root=path_test,
                                     split="test",
                                     target_types="segmentation",
                                     download=False,
                                     **utils.core.transform_dict)
...
if __name__ == '__main__':
    ...
    utils.core.t2img(pets_input_grid).show()
    ...
    utils.core.t2img(pets_targets_grid).show()